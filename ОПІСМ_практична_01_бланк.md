...
Відповідь: 44 рядків діагностичного виводу.
> 

**2. Які рядки наявні у виводі A.1 і відсутні у виводі A.2? Чим це зумовлено?**

Відповідь: У А.1 наявні всі діагностичні рядкі про домен, а у виводі А.2 у виводі маеться лише адресса домену, і спроба зв'язатися з доменом, за якою слідує помилка.
> 

**3. Звідки у виводі з'явилося значення `443`, якщо його не було вказано в адресі?**

Відповідь: номер мережевого порту https.
> 

**4. Як змінилося значення TTL між двома запитами (A.3)? Що означає це число?**

Відповідь: з TLL: 1185 до TTL: 835. TTL - максимальний період часу або кількість ітерацій або переходів, за який набір даних (пакет) може існувати до свого зникнення. 
> 
